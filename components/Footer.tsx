        ...
        <div className="flex flex-col md:flex-row justify-between gap-12">
            ...
            <div className="w-full md:w-1/3">
                <div className="flex items-center gap-2 mb-6">
                    <Shield className="w-12 h-12 text-neo-green" />
                    <h2 className="text-4xl font-black uppercase text-neo-green">DoomBlocker</h2>
                </div>
            ...
            <div className="w-full md:w-1/3 grid grid-cols-2 gap-8 font-mono font-bold uppercase">
                    ...
                    {status === 'success' ? (
                        ...
                        <form onSubmit={handleSubmit} className="flex">
                            <input 
                                ...
                                className="bg-neo-gray text-neo-black px-4 py-3 w-full font-mono border-4 border-neo-black border-r-0 focus:outline-none focus:bg-white disabled:opacity-50" 
                            />
                            <button 
                                type="submit"
                                disabled={status === 'submitting'}
                                className="bg-neo-black text-white px-4 border-4 border-neo-black font-bold uppercase hover:bg-neo-green hover:text-black transition-colors disabled:bg-gray-500 disabled:hover:text-white"
                            >
                                {status === 'submitting' ? '...' : '→'}
                            </button>
                        </form>
