...
const Features = () => {
  return (
    <section id="features" className="py-24 bg-neo-gray overflow-hidden">
        <div className="container mx-auto px-4">
            <div className="mb-16 border-l-8 border-neo-black pl-4 md:pl-6">
                <h2 className="text-3xl sm:text-5xl md:text-7xl font-black uppercase text-neo-black leading-none">
                    Hardware That <br/>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-auto md:grid-rows-2 gap-6">
                ...
                <div className="md:col-span-2 row-span-2 bg-neo-white border-4 border-neo-black shadow-neo-lg p-6 md:p-8 flex flex-col justify-between group hover:bg-neo-green transition-colors">
                    <div>
                        ...
                        <h3 className="text-2xl md:text-3xl font-black uppercase mb-4">Vetted Apps Only</h3>
                        <p className="font-mono font-bold text-base md:text-lg">No App Store. No side-loading. We curate a list of 100% safe utility apps (Calculator, Maps, Music, School Tools). If it scrolls, it's gone.</p>
                    </div>
                ...
                <div className="md:col-span-2 bg-neo-yellow border-4 border-neo-black shadow-neo p-6 md:p-8 flex items-center justify-between">
                    <div>
                        <h3 className="text-xl md:text-2xl font-black uppercase mb-2">Tamper-Proof OS</h3>
                        <p className="font-mono text-xs md:text-sm font-bold">Kids can't hack it. We tried.</p>
                    </div>
                    <Lock className="w-10 h-10 md:w-12 md:h-12 shrink-0 ml-4" />
                </div>
