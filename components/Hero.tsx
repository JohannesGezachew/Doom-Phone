      ...
      <div className="container mx-auto px-4 relative z-10 py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.9] mb-8 text-neo-black uppercase">
              Kill The <br/>
            ...
            <p className="font-mono text-lg md:text-xl max-w-xl mb-10 bg-neo-white border-l-8 border-neo-yellow pl-6 py-2">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <button 
                ...
                className="bg-neo-green px-8 py-5 text-xl font-black uppercase border-4 border-neo-black shadow-neo-lg hover:shadow-neo-hover hover:translate-x-1 hover:translate-y-1 transition-all flex items-center justify-center gap-3 group"
              >
          ...
          <div className="relative flex justify-center lg:justify-end">
             {/* The Phone */}
             <div className="relative w-[300px] h-[600px] bg-neo-black rounded-[3rem] border-4 border-neo-black shadow-neo-xl p-4 transform rotate-3 hover:rotate-0 transition-transform duration-500 cursor-default">
                {/* Screen */}
                <div className="w-full h-full bg-neo-white rounded-[2.5rem] overflow-hidden relative border-2 border-gray-800 flex flex-col">
                    {/* Status Bar */}
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center bg-neo-gray relative p-6 text-center space-y-6">
                         <div className="w-24 h-24 bg-neo-red rounded-full flex items-center justify-center border-4 border-neo-black animate-bounce shadow-neo">
                             <XCircle className="w-12 h-12 text-white" />
                         </div>
                         <div>
                             <h3 className="font-black text-2xl uppercase mb-2">App Blocked</h3>
                             <p className="font-mono text-xs font-bold">"TikTok" is not allowed on DoomBlocker OS.</p>
                         </div>
                         <div className="w-full bg-neo-white border-4 border-neo-black p-4 shadow-neo-sm">
                             <p className="font-mono text-xs uppercase font-bold text-neo-green">Go Read A Book Instead</p>
                         </div>
                    </div>
             ...
             {/* Floating Badge */}
             <div className="absolute bottom-20 -left-10 bg-neo-yellow px-6 py-4 border-4 border-neo-black shadow-neo lg:block hidden transform -rotate-6 animate-float">
